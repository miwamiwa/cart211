...
this.showInfo("  move by step  ", this.stepweight, leapx2, leapy2, x5-leapx2, y5-leapy2, leapstep2, leapstep2a);
this.showInfo("  move by leap  ", this.leapweight, leapx, leapy, x5-leapx, y5-leapy, leapstep1, leapstep1a);
...
if(currentMotion!=0){
  ...
  this.maxint = floor(map(-cos(this.section*0.0000001), -1, 1, 0, 7-this.minint));
  ...
  this.leapweight = floor(map(-cos(this.section*0.0003), -1, 1, 1, 10));
  this.stepweight = floor(map(cos(this.section*0.00011), -1, 1, 1, 10));
  ...
  drums.stimulusScale = floor(map(-cos(this.section*0.4), -1, 1, 25, 40));
  drums.bar = floor(map(sin(this.section*0.0001), -1, 1, 30, 120));
  drums.beat = floor(map(sin(this.section*0.0002), -1, 1, 10, 40));
  drums.subdiv = floor(map(sin(this.section*0.0003), -1, 1, 7, 30));
  drums.finediv = floor(map(sin(this.section*0.004), -1, 1, 3, 10));
  ...
  drums.thresh = floor(map(-cos(this.section*0.4), -1, 1, 20, 35));
